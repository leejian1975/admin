define(function(require,exports,module) {
  const _merge = require('../../../../src/utils/merge');
  const markNodeData = require('./util').markNodeData;
  const NODE_KEY = require('./util').NODE_KEY;
  ...
  var Node = function () {
    ...
    Node.prototype.doCreateChildren = function doCreateChildren(array) {
      ...
      array.forEach(function (item) {
        _this2.insertChild((0, _merge)({data: item}, defaultProps));
      });
    };
