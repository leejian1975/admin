...
define(function (require, exports, module) {
    const getFirstDayOfMonth = require('../util/index').getFirstDayOfMonth
    const getDayCountOfMonth = require('../util/index').getDayCountOfMonth
    const getWeekNumber = require('../util/index').getWeekNumber
    const getStartDateOfMonth = require('../util/index').getStartDateOfMonth
    const DAY_DURATION = require('../util/index').DAY_DURATION;
    ...
    module.exports = {
        mixins: [Locale],
        template : require('./date-table.tpl'),
        props: {
            firstDayOfWeek: {
                default: 7,
                type: Number,
