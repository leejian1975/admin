...
define(function (require, exports, module) {
  ...
  const objectAssign= require('../../../src/utils/merge');
  const getValueByPath = require('./util').getValueByPath;
  let columnIdSeed = 1;
  ...
  const forced = {
    ...
    index: {
      renderHeader: function (h, _ref2) {
        var column = _ref2.column;

        return column.label || '#';
      },
      renderCell: function (h, _ref3) {
    ...
    expand: {
      ...
      renderCell: function (h, _ref5, proxy) {
        var row = _ref5.row,
            store = _ref5.store;
