define(function (require, exports, module) {
  ...
  class TableLayout {
    ...
    update() {
      ...
      let flexColumns = flattenColumns.filter(function(column){ return  typeof column.width !== 'number'}
    )
      ;
      ...
      if (flexColumns.length > 0 && fit) {
        ...
        if (bodyMinWidth < bodyWidth - this.gutterWidth) { // DON'T HAVE SCROLL BAR
          ...
          if (flexColumns.length === 1) {
            ...
            const allColumnsWidth = flexColumns.reduce(function(prev, column) {prev + (column.minWidth || 80)}, 0
          )
            ;
